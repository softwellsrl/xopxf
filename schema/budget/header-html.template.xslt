...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="b:Header">
    ...
    <xsl:call-template name="rates">
      <xsl:with-param name="title" select="'@@sec_vatrates@@'"/>
      <xsl:with-param name="rows"  select="b:VatRates/b:VatRate"/>
    </xsl:call-template>
    <xsl:call-template name="rates">
      <xsl:with-param name="title" select="'@@sec_withholding@@'"/>
  ...
  <xsl:template name="groups">
    ...
    <xsl:choose>
      <xsl:when test="b:Groups/b:Group">
        <table>
          <thead><tr><th>@@c_code@@</th><th>@@c_name@@</th><th>@@c_scheme@@</th></tr></thead>
          <tbody>
      ...
      <xsl:otherwise><p class="empty">@@none_declared@@</p></xsl:otherwise>
    </xsl:choose>
  </xsl:template>
  ...
  <xsl:template name="phases">
    ...
    <xsl:choose>
      <xsl:when test="b:Phases/b:Phase">
        <table>
          <thead><tr><th>@@c_code@@</th><th>@@c_name@@</th><th>@@c_start@@</th><th>@@c_end@@</th></tr></thead>
          <tbody>
  ...
  <xsl:template name="producers">
    ...
    <xsl:choose>
      <xsl:when test="b:Producers/b:Producer">
        <table>
          <thead><tr><th>@@c_code@@</th><th>@@c_name@@</th><th>@@c_vatid@@</th></tr></thead>
          <tbody>
  ...
  <xsl:template name="detailTypes">
    <h2>@@sec_detailtypes@@</h2>
    <xsl:choose>
      <xsl:when test="b:DetailTypes/b:DetailType">
        <table>
          <thead><tr><th>@@c_code@@</th><th>@@c_name@@</th><th>@@c_contingency@@</th></tr></thead>
          <tbody>
  ...
  <xsl:template name="codeName">
    ...
    <xsl:choose>
      <xsl:when test="$rows">
        <table>
          <thead><tr><th>@@c_code@@</th><th>@@c_name@@</th></tr></thead>
          <tbody>
  ...
  <xsl:template name="rates">
    ...
    <xsl:choose>
      <xsl:when test="$rows">
        <table>
          <thead><tr><th>@@c_code@@</th><th>@@c_name@@</th><th class="num">@@c_rate@@</th></tr></thead>
          <tbody>
            <xsl:for-each select="$rows">
              <tr>
                <td><span class="code"><xsl:value-of select="@code"/></span></td>
